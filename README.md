...
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/coder-singh1699/Face-Detection.git/master)
![](https://github.com/coder-singh1699/Face-Detection/blob/master/data/pic.png)
...
## Installation
OpenCV-Python supports all the leading platforms like Mac OS, Linux, and Windows. It can be installed in one of the following ways:
...
reffer to the OpenCV Documentation --> (https://docs.opencv.org/master/d9/df8/tutorial_root.html)
...
1. [Binary Image](https://github.com/coder-singh1699/Face-Detection/blob/master/Images%20as%20Arrays/binary%20image.png)
2. [Grayscale image](https://github.com/coder-singh1699/Face-Detection/blob/master/Images%20as%20Arrays/graysclale.png)
3. [Coloured image](https://github.com/coder-singh1699/Face-Detection/blob/master/Images%20as%20Arrays/mandrill_colour.png)
